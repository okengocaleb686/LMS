...
foreach ($books_data as $book) {
    if ($book['available_quantity'] > 0) {
        $books[] = [
            'id' => $book['id'],
            'title' => $book['title'],
            'author' => $author_map[$book['author_id']] ?? 'Unknown',
            'category' => $category_map[$book['category_id']] ?? 'Unknown',
            'isbn' => $book['isbn'],
...
<head>
    ...
    <style>
        ...
        .request-btn { background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; padding: 8px 15px; text-decoration: none; border-radius: 6px; transition: transform 0.3s, box-shadow 0.3s; display: inline-block; }
        .request-btn:hover { transform: translateY(-2px); box-shadow: 0 4px 8px rgba(0,0,0,0.2); }
        ...
        @media (max-width: 768px) {
            ...
            th, td { padding: 10px; }
            .request-btn { padding: 6px 10px; font-size: 14px; }
        }
    </style>
</head>
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="issue_book.php?book_id=<?php echo $book['id']; ?>" class="request-btn"><i class="fas fa-plus"></i> Issue Book</a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
